function [residual, g1, g2] = nkm_static(y, x, params)
%
...
residual(5)= lhs-rhs;
lhs =y(9);
rhs =params(5)*y(8)+y(9)*(1+params(17))-params(16)*params(12)*(y(11)+y(1)*params(14))-y(6);
residual(6)= lhs-rhs;
lhs =y(6);
rhs =y(9)*params(11);
residual(7)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(5,5)=1;
  g1(6,1)=params(14)*params(16)*params(12);
  g1(6,6)=1;
  g1(6,8)=(-params(5));
  g1(6,9)=1-(1+params(17));
  g1(6,11)=params(16)*params(12);
  g1(7,6)=1;
  g1(7,9)=(-params(11));
  g1(8,2)=1;
  g1(8,3)=(-1);
  ...
  g1(9,4)=(-1);
  g1(9,11)=1;
  g1(10,7)=1-(1-params(8));
  g1(11,8)=1-(1-params(8));
  if ~isreal(g1)
