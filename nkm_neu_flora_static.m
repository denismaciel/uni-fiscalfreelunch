function [residual, g1, g2] = nkm_neu_flora_static(y, x, params)
%
...
residual(2)= lhs-rhs;
lhs =y(3);
rhs =max(0,y(2)*params(10)+y(1)*params(9));
residual(3)= lhs-rhs;
lhs =y(4);
...
if nargout >= 2,
  ...
  g1(2,1)=(-params(15));
  g1(2,2)=1-params(1);
  g1(3,1)=(-(params(9)*(1-(0>y(2)*params(10)+y(1)*params(9)))));
  g1(3,2)=(-(params(10)*(1-(0>y(2)*params(10)+y(1)*params(9)))));
  g1(3,3)=1;
  g1(4,4)=1;
