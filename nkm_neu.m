...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('nkm_neu_static');
erase_compiled_function('nkm_neu_dynamic');
...
make_ex_;
M_.exo_det_length = 0;
M_.Sigma_e(1, 1) = M_.params(18);
M_.Sigma_e(2, 2) = 0;
options_.irf = 20;
options_.order = 1;
var_list_=[];
info = stoch_simul(var_list_);
save('nkm_neu_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('nkm_neu_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('nkm_neu_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('nkm_neu_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('nkm_neu_results.mat', 'estimation_info', '-append');
end
