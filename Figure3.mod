...
// We need to define the variable x (the shocks) again with the value of the shocks since Dynare does not keep it after performing the loop.
...
//Calculate the marginal government spending multiplier and the effect government spending on government debt
...
//Combine values of shocks, output, governemnt spending and the liquidity trap duration into a single data frame called liqmul
...
/////////////////////////////////////////////////////////////////
//Figure 3: show the spending multipliers and government debt responses
figure;
...
/////////////////////////////////////////////
///// Save the results to build Figure 3 ////
/////////////////////////////////////////////

// Create mul_various if does not exist or load it if does
if exist('mul_file.mat', 'file') == 0
	mul_various = zeros(length(mul),1,4);
else
	load mul_file.mat;
end;
// Create p_balance if does not exist or load it if does
