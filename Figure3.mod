...
//Create vekor on Government Shock for Taste shock only (where sig_gov=0)
...
//Plotting Figure 3 to show Change in Government Debt to Actual GDP
figure;
plot(x(277:end), p(277:end), 'b',    'linewidth',3);
title('5 Quarter Price Contracts','fontweight','bold','FontSize',12)                  // change to "Alternative Price Contract Duration"
